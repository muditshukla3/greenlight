...
import (
	...
	"github.com/muditshukla3/greenlight/internal/validator"
...
var (
	...
	ErrEditConflict   = errors.New("conflict in update")
)
...
func ValidateUser(v *validator.Validator, user *User) {
	...
	v.Check(len(user.Name) <= 500, "name", "name must be less than 500 bytes")
...
func (u UserModel) GetForToken(scope, token string) (*User, error) {
